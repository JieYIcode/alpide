...
namespace FocalStringGroup {
  ...
  struct FocalStringGroup_O3 : public sc_module
  {
    ...
    private:
      ...
      // Distribution of ctrl in half-module
      std::array<ControlInitiatorSocket, Focal_Outer3::CHIPS> socket_control_out;
  };
  ...
  struct FocalStringGroup_O6 : public sc_module
  {
    ...
    private:
      ...
      // Distribution of ctrl in half-module
      std::array<ControlInitiatorSocket, Focal_Outer6::CHIPS> socket_control_out;
  };

///@brief A module for Focal consisting of FOCAL_CHIPS_PER_MODULE chips in IB configuration
  struct FocalStringGroup_I3 : public sc_module
  {
    FocalStringGroup_I3(sc_core::sc_module_name const &name,
                  Detector::DetectorPosition pos,
                  Detector::t_position_to_global_chip_id_func position_to_global_chip_id_func,
                  const AlpideConfig& cfg);
    ...
    sc_in_clk s_system_clk_in;
    ControlTargetSocket socket_control_in;                                 // IB module control in
    DataInitiatorSocket socket_data_out[Focal_Inner3::CHIPS]; // IB module data out
  ...
  private:
    ...
    // Distribution of ctrl to individual chips in string group
